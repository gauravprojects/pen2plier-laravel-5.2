...
<head>
    ...
    <title>Pen2Plier | @yield('title')   </title>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- IMG BASED LOGO  -->
                <a class="navbar-brand" href="{{ route('home') }}"><img src="img/logo.png" alt="logo" height="50" width="220"></a>
            </div>
